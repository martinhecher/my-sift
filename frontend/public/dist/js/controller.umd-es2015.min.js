...
/**
 * My Sift Sift. Frontend controller entry point.
 */
var MyController = (function (SiftController) {
  ...
  MyController.prototype.loadView = function loadView (state) {
    console.log('my-sift: loadView', state);
    ...
    switch (state.type) {
      ...
      default:
        console.error('my-sift: unknown Sift type: ', state.type);
    }
  };
  ...
  MyController.prototype.onStorageUpdate = function onStorageUpdate (value) {
    ...
    console.log('my-sift: onStorageUpdate: ', value);
